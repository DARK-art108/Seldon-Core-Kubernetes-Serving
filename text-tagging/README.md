...
```
$ s2i build . seldonio/seldon-core-s2i-python3:0.12 ritesh2000/text-tagging:0.1.0
$ docker push ritesh2000/text-tagging:0.1.0
```

#### Test

```
$ docker run --name "text-tagging" --rm ritesh2000/text-tagging:0.1.0
...
```
$ docker run --name "text-tagging" --rm -p 5001:5000 ritesh2000/text-tagging:0.1.0
