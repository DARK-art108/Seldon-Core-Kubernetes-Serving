...
```
$ s2i build . seldonio/seldon-core-s2i-python3:0.12 ritesh2000/summarize-text:0.1.0
$ docker push ritesh2000/summarize-text:0.1.0
```

#### Test

```
$ docker run --name "summarize-text" --rm ritesh2000/summarize-text:0.1.0
...
```
$ docker run --name "summarize-text" --rm -p 5001:5000 ritesh2000/summarize-text:0.1.0
